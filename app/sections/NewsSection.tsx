        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
            {currentPosts.map((post: any) => {
              ...
              return (
                <Link key={post.id || post.slug} href={`/post/${post.slug}`} className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow overflow-hidden">
